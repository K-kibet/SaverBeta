...
public class BusinessImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type = intent.getStringExtra("type");
           ...
           String path = MyConstants.ADD_DIR;
                ...
                getPure = MyConstants.BUSINESS_DIRECTORY;
    ...
    private void startDialog(String myPath) {
        final AlertDialog.Builder myAlertDialog = new AlertDialog.Builder(BusinessImageActivity.this);
        ...
        myAlertDialog.setPositiveButton("Delete",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        file.delete();
                        Toast.makeText(BusinessImageActivity.this, "Status Deleted", Toast.LENGTH_SHORT).show();
                        finish();
                        }
                });
