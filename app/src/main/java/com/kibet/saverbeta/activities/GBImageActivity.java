...
import com.kibet.saverbeta.Adapters.ImageAdapter;
import com.kibet.saverbeta.R;
import com.kibet.saverbeta.TouchImageView;
...
public class GBImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabs_menu = findViewById(R.id.fabs_menu);
        ...
        getPure = MyConstants.GB_DIRECTORY;
        myPackages = "GB WhatsApp";
           ...
           File[] files = getPure.listFiles(new FilenameFilter() {
            ...
            TouchImageAdapter adapter = new TouchImageAdapter(this, files);
    ...
    private class TouchImageAdapter extends PagerAdapter {
        ...
        TouchImageAdapter(Context context, File[] files) {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            Bitmap bitmap = BitmapFactory.decodeFile(String.valueOf(files[position]));
            Glide.with(context)
                    .asBitmap()
                    .load(files[position])
    ...
    private void startDialog(String myPath) {
        final AlertDialog.Builder myAlertDialog = new AlertDialog.Builder(GBImageActivity.this);
        ...
        myAlertDialog.setPositiveButton("Delete",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        file.delete();
                        Toast.makeText(GBImageActivity.this, "Status Deleted", Toast.LENGTH_SHORT).show();
                        finish();
                        }
                });
