...
import static com.kibet.saverbeta.fragments.BusinessVideoFragment.data;
...
public class BusinessVideoActivity extends AppCompatActivity implements SurfaceHolder.Callback, MediaController.MediaPlayerControl, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myPackage = "com.whatsapp.w4b";
        myPackages = "Business WhatsApp";

        mp = new MediaPlayer();
        if(mediaController == null){
            mediaController = new MediaController(BusinessVideoActivity.this);
        }
    ...
    private void startDialog(String myPath) {
        final AlertDialog.Builder myAlertDialog = new AlertDialog.Builder(BusinessVideoActivity.this);
        ...
        myAlertDialog.setPositiveButton("Delete",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        file.delete();
                        Toast.makeText(BusinessVideoActivity.this, "Status Deleted", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
