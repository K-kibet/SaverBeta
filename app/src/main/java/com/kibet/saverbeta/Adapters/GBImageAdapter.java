...
import com.kibet.saverbeta.activities.GBImageActivity;
...
public class GBImageAdapter extends RecyclerView.Adapter<GBImageAdapter.ImageViewHolder> {
    ...
    public GBImageAdapter(Context context, ArrayList<ModelStatus> imageList, List<ModelStatus> selected_image, GBImageFragment imageFragment){
