...
import com.kibet.saverbeta.activities.BusinessImageActivity;
...
public class BusinessImageAdapter extends RecyclerView.Adapter<BusinessImageAdapter.ImageViewHolder> {
    ...
    public BusinessImageAdapter(Context context, List<ModelStatus> imageList, List<ModelStatus> selected_image, BusinessImageFragment imageFragment){
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        holder.ivThumbnailImageView.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(acontext, BusinessImageActivity.class);
