...
import com.kibet.saverbeta.activities.GBVideoActivity;
...
public class GBVideoAdapter extends RecyclerView.Adapter<GBVideoAdapter.VideoViewHolder> {
    public List<ModelStatus> videoList;
    public ArrayList<ModelStatus> selected_videoList;
    Context context;
    GBVideoFragment videoFragment;
    public final static String POSITION = "Image Position";
    public OnItemClickListener onItemClickListener;

    public GBVideoAdapter(Context context, List<ModelStatus> videoList, ArrayList<ModelStatus> selected_video, GBVideoFragment videoFragment){
    ...
    public void onBindViewHolder(@NonNull VideoViewHolder holder, int position) {
        ...
        holder.ivThumbnailImageView.setOnClickListener(v -> {
            ...
            Intent i = new Intent(context, GBVideoActivity.class);
