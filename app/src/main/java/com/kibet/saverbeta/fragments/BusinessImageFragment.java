...
import com.kibet.saverbeta.Adapters.BusinessImageAdapter;
import com.kibet.saverbeta.Model.StatusModel;
...
public class BusinessImageFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    ArrayList<StatusModel> data= new ArrayList<>();
    ArrayList<StatusModel> dataSelected= new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        loadData();
        imageAdapter = new BusinessImageAdapter(getContext(), data, dataSelected,BusinessImageFragment.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemLongClick(View view, int position) {
                if (!isMultiSelect) {
                    dataSelected = new ArrayList<StatusModel>();
                    isMultiSelect = true;
    ...
    public void loadData() {
        data = new ArrayList<>();
        final String path = MyConstants.BusinessDirectoryPath;
