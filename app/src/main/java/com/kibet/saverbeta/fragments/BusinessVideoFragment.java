...
import com.kibet.saverbeta.Adapters.BusinessVideoAdapter;
...
public class BusinessVideoFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        videoAdapter = new BusinessVideoAdapter(getContext(), data, dataSelected,BusinessVideoFragment.this);
